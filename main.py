...
Руководство:
В корневую папку засунуть файлы:
1) Выкачанный из Скопуса csv-файл с нужным списком публикаций
(удостовериться, что поставлена галочка на библиографической информации)
2) Файл, сформированный при копировании авторов из выпадающего списка
слева в блокнот.
Указать ORGANIZATION - по вхождению этой фразы проводится фильтрация авторов
(указывать поэтому лучше важную часть названия, но не все название, т.к. оно
